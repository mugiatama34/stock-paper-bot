"""
Mean-Reversion (Wide Stop) Strategy  — BACKTEST-ONLY, canlıda çalışmaz
------------------------------------------------------------------------
mean_reversion.py'nin varyasyonu: yalnızca izleyen stop çarpanı farklı
(2.5×ATR yerine 4.0×ATR). Giriş kuralı, çıkış sinyali, pozisyon
boyutlandırma ve rejim filtresi mean_reversion.py ile birebir aynı.
...
Exit:
  ...
  - trailing stop hit                handled centrally (peak - 4.0*ATR)
"""
